\
-- E2E — Ciné‑Tunisie (PostgreSQL)
-- Usage: psql -d votre_base -f e2e_cine_psql.sql
-- Hypothèse: ce fichier .sql est dans le même dossier que les CSV.
...
-- 3) Vues & contrôles
CREATE OR REPLACE VIEW vue_places_par_seance AS
...
CREATE OR REPLACE VIEW vue_taux_remplissage AS
