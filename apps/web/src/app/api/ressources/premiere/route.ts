...
export async function GET() {
  const overridePath = process.env.RES_PREMIERE_HTML;
  const candidates = [
    overridePath,
    '/home/alaeddine/Interface_NSI_2025_2026_local/Ressources_NSI_Premiere.html',
    '/app/Ressources_NSI_Premiere.html',
    path.join(process.cwd(), 'Ressources_NSI_Première.html'),
    path.join(process.cwd(), 'Ressources_NSI_Premiere.html'),
  ...
  return NextResponse.json({ ok: false, error: 'Ressource non trouvée' }, { status: 404 });
}
